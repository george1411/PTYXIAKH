...
import { checkExerciseConflict } from '../../controllers/trainer/exerciseCheck.controller.js';
...
trainerRouter.post('/clients/:clientId/check-exercise',    authorize, checkExerciseConflict);
