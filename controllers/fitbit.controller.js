...
export const switchFitbitAccount = async (req, res) => {
    try {
        ...
        res.redirect('https://rumor-scientist-manpower.ngrok-free.app/fitbit-done?fitbit=error');
    }
};
...
export const fitbitCallback = async (req, res) => {
    try {
        ...
        if (!code || !state) return res.redirect('https://rumor-scientist-manpower.ngrok-free.app/fitbit-done?fitbit=error');
        ...
        res.redirect('https://rumor-scientist-manpower.ngrok-free.app/fitbit-done?fitbit=connected');
    } catch (err) {
